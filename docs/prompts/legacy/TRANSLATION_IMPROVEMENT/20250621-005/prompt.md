...
* DO NOT INCLUDE the markdown front matter, the section between the "---" at the beginning of the document
...
- the full, improved translation in {{target_language}}. Do not include any preambles, explanations, or comments.
