...
1. Accuracy and Fidelity: The translation must be an exact and faithful representation of the source text. Do not add,
   omit, or interpret information. Maintain the formal, and often legalistic, tone of university regulations.
...
3. After completing the initial translation, perform a final review to ensure perfect accuracy, natural phrasing in the
   language represented by the ISO 639-1 two-letter code {{target_language}}, and flawless replication of the original
   format and placeholder styles.
...
- the full, improved translation in {{target_language}}.
