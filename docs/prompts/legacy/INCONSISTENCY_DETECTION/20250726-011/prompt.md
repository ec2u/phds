...
**Very Important**: if there are already KNOWN ISSUE, only highlight clashes of critical severity. If none is present,
you MUST return an empty list. Otherwise, if no KNOWN ISSUES are there, highlight and report all possible clashes.
