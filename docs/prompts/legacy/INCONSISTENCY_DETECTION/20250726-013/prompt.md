...
**Very Important**:
If there are already KNOWN ISSUES, return an empty list, unless super-critical clashes are found — although these are
unlikely to be present. If no KNOWN ISSUES exist, then check for and report all potential clashes.
