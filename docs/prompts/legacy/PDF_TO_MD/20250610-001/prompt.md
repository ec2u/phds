...
- **Lists:**
  ...
  - **Spacing Rule:** **Crucially, add a single blank line after the end of every list** (both ordered and unordered) to
    ensure proper rendering and readability.
- **Tables:**
...
- **Omit Completely:**
  ...
  - **Signature Blocks:** All sections dedicated to signatures, including names, titles, dates, locations, and signature
    lines.
  ...
  - **Ancillary Bureaucratic Details:** Sections containing only internal office routing codes, document version
    footers, or simple contact lists for administrative staff (unless part of a formal "Notices" clause which should be
    retained).
- **Placeholders:**
